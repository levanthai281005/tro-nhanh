...
- **Riêng tư:** trang khu public không lộ vận hành (BR-024); dashboard toggle mặc định ẩn (BR-012); người được liên kết vào phòng luôn nhận thông báo và có nút "Không phải tôi" để tự gỡ (BR-029); mã QR VietQR sinh tại máy người dùng, không gửi số tài khoản sang bên thứ ba.
